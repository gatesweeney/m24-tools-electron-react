...
- Added macOS zip target for auto-updater (dmg alone cannot be used for in-app updates).
- Ensure updater install sets quit flag so macOS restart isn’t blocked by the window hide-on-close behavior.
